...
keymap("n", "<leader>cf", "<cmd>lua vim.lsp.buf.formatting()<CR>", silent)
...
keymap("n", "<Enter>", "<cmd>:call append(line('.'), '')<CR>", silent)
keymap("n", "<S-Enter>", "<cmd>:call append(line('.') -1 , '')<CR>", silent)
